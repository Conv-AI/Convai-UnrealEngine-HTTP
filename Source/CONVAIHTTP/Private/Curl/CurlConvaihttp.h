...
/**
 * Curl implementation of an CONVAIHTTP request
 */
class FCurlConvaihttpRequest : public IConvaihttpThreadedRequest
{
public:

	// implementation friends
	friend class FCurlConvaihttpResponse;
	...
	/**
	 * Perform the convaihttp-thread setup of the request
	 *
	 * @return true if the request was successfully setup
	 */
	bool SetupRequestConvaihttpThread();

	/**
	 * Returns libcurl's easy handle - needed for CONVAIHTTP manager.
	 *
	...
	/**
	 * Marks request as completed (set by CONVAIHTTP manager).
	 *
...
private:
	 ...
	 * @param UserData data we associated with request (will be a pointer to FCurlConvaihttpRequest instance)
...
private:
	...
	float ElapsedTime;
	/** Elapsed time since the last received CONVAIHTTP response. */
...
/**
 * Curl implementation of an CONVAIHTTP response
 */
class FCurlConvaihttpResponse : public IConvaihttpResponse
{
private:

	/** Request that owns this response */
	FCurlConvaihttpRequest& Request;


public:
	// implementation friends
	friend class FCurlConvaihttpRequest;
	 ...
	 */
	FCurlConvaihttpResponse(FCurlConvaihttpRequest& InRequest);

	/**
	 * Destructor
	 */
	virtual ~FCurlConvaihttpResponse();

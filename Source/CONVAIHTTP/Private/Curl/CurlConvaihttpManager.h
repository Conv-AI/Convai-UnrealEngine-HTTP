...
class FCurlConvaihttpManager : public FConvaihttpManager
{
public:
	...
	//~ Begin ConvaihttpManager Interface
...
protected:
	virtual FConvaihttpThread* CreateConvaihttpThread() override;
	//~ End ConvaihttpManager Interface
};

 ...
 */
class CONVAIHTTP_API FWindowsPlatformConvaihttp : public FGenericPlatformConvaihttp
{
public:
...
typedef FWindowsPlatformConvaihttp FPlatformConvaihttp;
#endif // WINDOWS_USE_FEATURE_PLATFORMCONVAIHTTP_CLASS

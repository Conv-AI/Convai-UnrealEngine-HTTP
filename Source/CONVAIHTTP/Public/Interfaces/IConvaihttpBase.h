...
/**
 * Base interface for Convaihttp Requests and Responses.
 */
class IConvaihttpBase
{
public:
	 ...
	 */
	virtual TArray64<FString> GetAllHeaders() const = 0;
	 ...
	 */
	virtual ~IConvaihttpBase() = default;
};

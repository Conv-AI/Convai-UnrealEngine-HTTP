 ...
 * Intended usage is to use FPlatformConvaihttp instead of FGenericPlatformConvaihttp
 */
class CONVAIHTTP_API FGenericPlatformConvaihttp
{
public:
	...
	/**
	 * Check if a platform uses the CONVAIHTTP thread
	 *
	 * @return true if the platform uses threaded CONVAIHTTP, false if not
	 */
	static bool UsesThreadedConvaihttp();
	...
	/** 
	* Returns the domain and port portion of the URL, e.g., "a.b.c:d" of "convaihttp://a.b.c:d/e"
	...
	*/
	...
	/** 
	 * Returns the domain portion of the URL, e.g., "a.b.c" of "convaihttp://a.b.c:d/e"
	...
	/**
	 * Returns the default User-Agent string to use in CONVAIHTTP requests.
	...
	/**
	 * Extract the Port part of a URL, or an unset object if there was non specified. Example: "convaihttp://example.org:23/" would return 23, while "convaihttps://example.org/" would return an unset object
	 * 
	...
	/**
	 * Check the protocol of the provided URL to determine if this is for a secure connection (CONVAIHTTPS, WSS, etc)
	 *
